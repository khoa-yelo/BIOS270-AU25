...
To add a DESeq2 step that runs only after all salmon jobs for all samples have been completed:
- Collect all salmon job IDs as they are submitted
- Submit a DESeq2 job that depends on all salmon jobs completing (checking the salmon job IDs)

**Nextflow Pipeline**
Finished running! Had to increase memory allocation for Salmon step

**Screenshot**
![Screenshot Nextflow pipeline completed](./Nextflow_completed_screenshot.png)
